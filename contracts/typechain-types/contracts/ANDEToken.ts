...
export interface ANDETokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface ANDEToken extends BaseContract {
  connect(runner?: ContractRunner | null): ANDEToken;
  waitForDeployment(): Promise<this>;

  interface: ANDETokenInterface;
