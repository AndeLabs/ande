...
contract P2POracleTest is Test {
    ...
    function setUp() public {
        ...
        P2POracle oracleImpl = new P2POracle();
        bytes memory initData = abi.encodeWithSelector(
            P2POracle.initialize.selector, admin, address(andeToken), INITIAL_STAKE, EPOCH_DURATION
        );
    ...
    function test_Slash_EmitsSlashedEvent() public {
        ...
        emit P2POracle.ReporterSlashed(reporter1, INITIAL_STAKE);
