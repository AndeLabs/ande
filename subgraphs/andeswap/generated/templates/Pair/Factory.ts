...
export class FeeToSet extends ethereum.Event {
  get params(): FeeToSet__Params {
    return new FeeToSet__Params(this);
  }
}

export class FeeToSet__Params {
  _event: FeeToSet;

  constructor(event: FeeToSet) {
    this._event = event;
  }

  get oldFeeTo(): Address {
...
export class FeeToSetterSet extends ethereum.Event {
  get params(): FeeToSetterSet__Params {
    return new FeeToSetterSet__Params(this);
  }
}

export class FeeToSetterSet__Params {
  _event: FeeToSetterSet;

  constructor(event: FeeToSetterSet) {
    this._event = event;
  }
